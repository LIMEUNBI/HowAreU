...
public class CourseQuestion1Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_question_one);
        ...
        if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q1, "").equals(mResponse1.getText().toString())) {
            mCheck1.setChecked(true);
        } else if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q1, "").equals(mResponse2.getText().toString())) {
        ...
        mTxtAfter.setOnClickListener(v -> {
            if (!mCheck1.isChecked() && !mCheck2.isChecked()) {
                ...
                SharedPreferenceBase.putPrefBoolean(getApplicationContext(), Config.COURSE_QUESTION_ONE, true);
                ...
                if (mCheck1.isChecked()) {
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q1, mResponse1.getText().toString());
                    ...
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q1, mResponse2.getText().toString());
                ...
                Intent intent = new Intent(CourseQuestion1Activity.this, CourseQuestion2Activity.class);
    ...
    private void setImg() {
        ...
        mImgOne.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.icon_one_green));
