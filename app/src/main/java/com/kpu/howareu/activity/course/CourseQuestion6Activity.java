...
public class CourseQuestion6Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_question_six);
        ...
        if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q6, "").equals(mResponse1.getText().toString())) {
            mCheck1.setChecked(true);
        } else if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q6, "").equals(mResponse2.getText().toString())) {
            mCheck2.setChecked(true);
        }

        mTxtBefore.setOnClickListener(v -> {
            Intent intent = new Intent(CourseQuestion6Activity.this, CourseQuestion5Activity.class);
        ...
        mTxtAfter.setOnClickListener(v -> {
            if (!mCheck1.isChecked() && !mCheck2.isChecked()) {
                ...
                SharedPreferenceBase.putPrefBoolean(getApplicationContext(), Config.COURSE_QUESTION_SIX, true);
                ...
                if (mCheck1.isChecked()) {
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q6, mResponse1.getText().toString());
                    ...
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q6, mResponse2.getText().toString());
                ...
                Intent intent = new Intent(CourseQuestion6Activity.this, CourseQuestion7Activity.class);
                intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                finish();
            }
    ...
    private void setImg() {
        ...
        mImgSix.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.icon_six_green));
