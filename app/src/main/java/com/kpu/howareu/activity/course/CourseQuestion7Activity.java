...
public class CourseQuestion7Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_question_seven);
        ...
        if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q7, "").equals(mResponse1.getText().toString())) {
            mCheck1.setChecked(true);
        } else if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q7, "").equals(mResponse2.getText().toString())) {
            mCheck2.setChecked(true);
        }

        mTxtBefore.setOnClickListener(v -> {
            Intent intent = new Intent(CourseQuestion7Activity.this, CourseQuestion6Activity.class);
        ...
        mTxtAfter.setOnClickListener(v -> {
            if (!mCheck1.isChecked() && !mCheck2.isChecked()) {
                ...
                SharedPreferenceBase.putPrefBoolean(getApplicationContext(), Config.COURSE_QUESTION_SEVEN, true);
                ...
                if (mCheck1.isChecked()) {
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q7, mResponse1.getText().toString());
                    ...
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q7, mResponse2.getText().toString());
                ...
                map.put(Config.COURSE_COMPUTER, computer);
                map.put(Config.COURSE_MEDICAL, medical);
                map.put(Config.COURSE_DESIGN, design);
                map.put(Config.COURSE_ART, art);
                map.put(Config.COURSE_EDUCATION, education);
                map.put(Config.COURSE_SOCIAL_SCIENCE, socialScience);

                String course = Collections.max(map.entrySet(), Comparator.comparingInt(Map.Entry::getValue)).getKey();
                SharedPreferenceBase.putPrefString(getApplicationContext(), Config.USER_COURSE, course);

                Intent intent = new Intent(CourseQuestion7Activity.this, CourseRecommendActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void setImg() {
        ...
        if (isCheckFive) {
            mImgFive.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.icon_check));
        } else {
            mImgFive.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.icon_five_white));
        }
        ...
        mImgSeven.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.icon_seven_green));
