...
public class CourseQuestion3Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_question_three);
        ...
        if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q3, "").equals(mResponse1.getText().toString())) {
            mCheck1.setChecked(true);
        } else if (SharedPreferenceBase.getPrefString(getApplicationContext(), Config.Q3, "").equals(mResponse2.getText().toString())) {
            mCheck2.setChecked(true);
        }

        mTxtBefore.setOnClickListener(v -> {
            Intent intent = new Intent(CourseQuestion3Activity.this, CourseQuestion2Activity.class);
        ...
        mTxtAfter.setOnClickListener(v -> {
            if (!mCheck1.isChecked() && !mCheck2.isChecked()) {
                ...
                SharedPreferenceBase.putPrefBoolean(getApplicationContext(), Config.COURSE_QUESTION_THREE, true);
                ...
                if (mCheck1.isChecked()) {
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q3, mResponse1.getText().toString());
                    ...
                    SharedPreferenceBase.putPrefString(getApplicationContext(), Config.Q3, mResponse2.getText().toString());
                ...
                Intent intent = new Intent(CourseQuestion3Activity.this, CourseQuestion4Activity.class);
                intent.addFlags (Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                finish();
            }
    ...
    private void setImg() {
        ...
        mImgThree.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.icon_three_green));
